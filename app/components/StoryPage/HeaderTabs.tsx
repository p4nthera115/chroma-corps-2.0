...
export const HeaderTabs = () => {
  ...
  return (
    <div
      id="Menu-list"
      className="flex flex-row md:max-w-full md:w-full xs:max-w-fit justify-center mx-auto"
    >
      <Link
        id="Menu-link-2X20"
        href={pathname === "/story/2X20" ? "/story" : "/story/2X20"}
        className={`text-3xl font-cyber w-full py-8 xs:px-4 max-w-fit md:max-w-full sm:px-6 md:px-8 ${
