...
const SmallElimBanner: React.FC<EliminatedBannerProps> = ({
  ...
  return (
    <div
      className={`hover:cursor-pointer relative h-[33.333333333vh] z-10 border-red-600/50 border w-full ${elimType.cadet.gradient} z-20  flex justify-center items-center overflow-hidden`}
      onClick={() => router.push(`/cadets/${year}/${elimType?.cadet.name}`)}
    >
