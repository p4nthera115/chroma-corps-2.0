        ...
        {winner.length > 1 ? (
              ...
              {winner.map((cadet: CadetAssignment, i: number) => (
                ...
                >
                  <img
                    ...
                    className={`h-full scale-[120%] min-w-max z-20 object-contain pointer-events-none justify-between`}
                  />
                  <h2
                    key={i}
          ...
          >
            <img
              src={winner[0]?.cadet.bannerImg[0]}
              alt={winner[0]?.cadet?.name}
              className={`${winner[0]?.cadet?.bannerPos} object-contain pointer-events-none flex z-20`}
            />
            <h2
